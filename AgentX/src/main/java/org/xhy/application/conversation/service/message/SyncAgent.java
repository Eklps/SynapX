...
/** 同步Agent接口，用于非流式对话场景。
 * <p>
 * 与 {@link Agent}（返回 {@link dev.langchain4j.service.TokenStream} 的流式接口）对应， 本接口返回纯文本，适用于通过
 * {@link dev.langchain4j.service.AiServices} + {@link dev.langchain4j.model.chat.ChatModel}
